...
import { Container, Header, AudioList, SongItem, PlayIconPlay } from "./styles";
            ...
            {!playlist.exercises ? (
              ...
              playlist.exercises.map(exercise => (
                <SongItem
                  ...
                  onDoubleClick={() =>
                    this.props.loadSong(exercise, playlist.exercises)
                  }
                ...
                >
                  <td>
                    <PlayIconPlay
                      ...
                      alt="Play"
                      onClick={() =>
                        this.props.loadSong(exercise, playlist.exercises, 0)
                      }
                    />
                  </td>
                  <td>{exercise.ex}</td>
